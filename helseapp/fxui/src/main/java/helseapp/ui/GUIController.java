...
public class GUIController implements Initializable {
  ...
  /**
   * Lagrer data fra TextField-feltene i appen. Data lagres basert på dato, med
   * ett datasett per dato. Hvis feltene ikke er fylt inn lagres verdien 0
   */
  @FXML
  void lagreData() {
    ...
    // Lagring:
    fileData.saveDag(new Dag(tallData[0], tallData[1], tallData[2], tallData[3], tallData[4], 
        tallData[5], date), savePath);
  }
   ...
   *
   * @param dag Dag-objekt som inneholder dataene som skal vises i
   *            TextField-feltene
   */
  ...
  /**
   * Henter data som er lagret og legger det inn i grafene. Viser deretter
   * grafene.
   *
  ...
  /**
   * Initialiserer appen Legger inn testdata i grafene Viser grafene i appen.
