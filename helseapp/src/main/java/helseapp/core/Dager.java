...
public class Dager implements Iterable<Dag> {
	...
	*/
    ...
    /**
	* metode for å legge til en collection av dager på slutten av listen av dagerobjekt
	...
	*/
	...
	/**
	* metode for å gjøre en liste med dagerobjekter til en collection og legge dem til liste av eksisterende dagerobjekt
	* @param dager - liste av dagerobjekt som skal legges til
	* @return addDager - kaller metoden over og returnerer pos, posisjonen til første av dagene som legges til
	*/
